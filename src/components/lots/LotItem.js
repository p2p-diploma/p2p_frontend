  ...
  return <tr className="lotItem">
    ...
    <td>
      <div className="row"><div className="col-md-4">Available:</div>
        <div className="col-md-8 text-large available">{props.lot.supply}
          {props.lot.crypto_currency === 'eth' && ' ETH'}
          {props.lot.crypto_currency === 'erc20' && ' ERC20'}</div></div>
    ...
    <td>
      <button onMouseDown={onShowModal} type="button" className="btn btn-success d-block"
      ...
      {isModal && <LotModal lot={props.lot} />}
